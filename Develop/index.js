...
const fs = require('fs');
const fileName = "./Develop/newREADME/README.md"
...
const writeFile = (fileName, data) => {
    return new Promise((resolve, reject) => {
        fs.writeFile(fileName, data, writeFileError => {
            if (writeFileError) {
...
const init = () => {
    ...
    return inquirer.prompt(questions)
        .then(readmeDataQuestions => {
            return readmeDataQuestions;
        })
}
...
init()
    .then(readmeDataQuestions => {
        console.log(readmeDataQuestions);
        return generateMarkdown(readmeDataQuestions);
    })
    .then(pageMD => {

        return writeFile(fileName, pageMD);
    })
    .then(response => {
        console.log(response.message);
        console.log("File Path : ", response.fileName)
    })
    .catch(err => {
        console.log(err);
    })
